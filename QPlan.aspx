<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="QPlan.aspx.cs" Inherits="_Default" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="col-md-4" style="align-content:center; font-size: 15px; font-style: inherit;">
                ...
                <br />
                &nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click"> የሩብ አመት እቅድ ማስገቢያ</asp:LinkButton>
&nbsp;<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" OnTextChanged="DropDownList1_TextChanged">
                    <asp:ListItem Selected="True">---ሩብ አመት---</asp:ListItem>
                    <asp:ListItem> ሩብ አመት 1</asp:ListItem>
                    <asp:ListItem> ሩብ አመት 2</asp:ListItem>
                    <asp:ListItem> ሩብ አመት 3</asp:ListItem>
                    <asp:ListItem> ሩብ አመት 4</asp:ListItem>
                </asp:DropDownList>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
